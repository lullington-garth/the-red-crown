...
export function resolveShepherdsHutVariable(path, playerStats) {
    ...
    switch (path) {
        ...
        case "hutIgnore":
            ...
            if (wizard === "yellow") {
                return `Ignore the smokehouse and carry on south?`;
            }
            if (wizard === "blue") {
...
The door sits slightly ajar, and the earth around the doorway shows recent footprints, though nobody appears to be home presently.`;
            }
            if (wizard === "yellow") {
...
Before long, you pass a derelict lambing shed standing beside the road. Its weather-beaten timber walls are silvered with age, while roofing slats lie crooked and gappy like broken teeth. A faint smell of animal remains drifts from the half-open doorway.`;
            }
            if (wizard === "red") {
...
Villagers rush frantically back and forth with buckets filled from water troughs while terrified horses scream inside a nearby stable. Sparks whirl upwards into the smoke-darkened sky, and the heat strikes your face even from a distance.
...
`;
            ...
            if (wizard === "yellow") {
                return `You lift the heavy apron from the table and discover a folded scrap of parchment tucked behind the pocket.

It reads:

‘Jane, you say you have found the key to entering the brothers’ realm. Well, I have found a doorway for your key. It is not far from here. Head south. The stones have been sighted. K.’

You read the message again before slipping it back into the pocket.

You slip the apron over your shoulders and pull the straps tight. The leather settles heavily against your body, but instead of restricting your movement, it makes you feel agile and lighter, as though your movements have been honed by years of focused practice.
...
As you stand, you feel lighter and more balanced. Your movements become sharper, quicker, and more precise. The boots are undoubtedly magical.
