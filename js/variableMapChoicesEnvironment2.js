...
case "Environment2Enter":
    if (wizard === "green") { return `You continue deeper into Carolinus's domain until, without warning, a rift tears across the realm, spewing alien magic into the woodland ahead.
...
Then the forest begins to sink. The colossal trees do not appear to rise into the sky. Instead, their impossible growth seems to drive them downward, forcing the woodland deep into the earth and causing the ground before you to break apart and fall away.
...
Which route will you take?`;}
if (wizard === "blue") { return `You pick up a path that leads you to a silver shoreline, which you follow until you arrive at a cave mouth. You venture into the cave until the silver sands of the distant shore lie only as a thin dusting across the stone floor, and the sound of the sea has long since faded behind you.
...
The magic of another realm, alien to this one, pours into the darkness. The wound in reality closes almost immediately, but its influence remains. The cave thunders, and stone screams against stone. The entire passage splits apart, and the ceiling groans overhead.

You dive to the dust-covered floor as stones hail from above. The crack through which the starlight once shone seals itself beneath the falling rock, plunging much of the cavern into darkness.

Crystal erupts from the stone walls in great jagged spears, ripping new tunnels into the rock. Somewhere deep below, you hear the roar of shifting rock, while above, the cavern rings with the sounds of a howling distant wind.
...
The passage lined with glowing moon moss remains. With the starlight above blocked by the falling rock, the only light on that route now comes from the pale glow of the moss. It is dim, but enough for you to make out that the moss and tunnel snake deeper into the rock.

The crystal has torn its own passage through the rock. Vast shards protrude from the floor, walls, and ceiling at impossible angles. The route appears difficult but still passable.
...
The final passage is more of a fissure ripped into the cave floor. Warm air rises from below, and a soft orange glow illuminates its depths. Though the heat is unsettling, the fissure wall has easy handholds, and the route down appears simple enough.
...
case "Environment2EnterChoice1":
    ...
    if (wizard === "yellow") { return `Will you take the path directly through the storm cloud?`;}
    if (wizard === "blue") { return `Will you follow the glowing moon moss into the darkness?`;}   
            
case "Environment2EnterChoice2":
    if (wizard === "green") { return `Will you traverse the crumbling path to the knotted tree roots?`;}
    if (wizard === "yellow") { return `Will you take the route through the swirling clouds where the winds are strongest?`;}
    if (wizard === "blue") { return `Will you pick your way through the crystal cavern?`;}   
...
case "Environment2EnterChoice3":
    ...
    if (wizard === "blue") { return `Will you climb the rise up to the tunnel where the sound of the wind can be heard?`;}   
...
case "Environment2EnterChoice4":
    ...
    if (wizard === "blue") { return `Or would you descend into the orange glow and rising heat?`;}   
...
The pale growth clings to the walls and floor, illuminating the tunnel with a ghostly silver light. At first, you are grateful for the guidance, but not far down the tunnel you start to notice a smell. A sharp, acrid tang hangs in the air.
...
With your head swimming, you lean heavily against the cave wall, gasping for breath that you cannot draw.
...
You almost collide with a drifting energy ball. It passes close enough that the branch you are on creaks and contracts beneath your feet. You dive, the once massive limb shrinking and snapping beneath your weight. You land on safer branches as the severed limb tumbles hundreds of feet into the flooded forest below.

You have barely enough time to gather yourself before the air shimmers around you. Leaves shrink, bark cracks, and entire sections of the canopy you are in begin to collapse. You sprint along a narrowing branch before throwing yourself into the next tree.

Here at last, the magical disturbance begins to thin, and the vast branches slope steadily downward until the canopy rises to meet a high ridge overlooking the devastated forest.
...
Your vision darkens and you stumble, nearly falling into a hidden fissure concealed beneath the silver glow. You leap back. Your head swims, and you see figures moving in the darkness beyond the moss, but they are gone in the blink of an eye, just a vision brought on by the poisonous vapours that you are breathing.

You stumble on, and at last the tunnels begin to widen and the air slowly clears. Ahead, you see pale light. Not moss, something wider. Sands.
...
case "Environment2TestEthosPassChoice":
    ...
    if (wizard === "blue") { return `When you have recovered, gather your horse and continue along the shore.`;}
...
As the map unfolds itself in your hands, lines shift and redraw themselves as the drifting magic alters the surrounding trees. Safe paths appear and disappear while glowing trails weave across the parchment.
...
Paying careful attention to the map, you set off again. For a while, your route is clear, but it is not long before the map shows no safe routes. Looking up, you see two shimmers in the air converging on your spot in the trees.

You run. The branch you are on screams out as it struggles to support you while the passing disturbance shrinks it. You dive onto the next branch, feeling that withering too. There is a snapping sound; the branch breaks and you tumble. You thump heavily onto a lower branch and sprint. You can see the edge of the canopy now. You hurl yourself towards it. Behind you, you can hear the groaning and whipping of branches as they fold under the effects of the passing magic.

You burst from the canopy, landing on the solid ground of the valley peak beyond, and lie gasping, your heart racing.`;}
...
You wrap it around your mouth and nose, filtering out the acidic air while at the same time feeding the moss around you and slowing the poisonous spore production.

The acrid fumes begin to lessen around you and the glowing moon moss begins to brighten, illuminating the path ahead.
...
case "Environment2HaveItemChoice":
    if (wizard === "green") { return `When you are ready, gather your horse and head down the slope.`;}
    if (wizard === "yellow") { return `When you are ready, continue to the bridge leading from the island.`;}
...
You mount carefully and turn the animal towards what appears to be the safest route, then you spur it into action. The horse surges forward.
...
Moments later, you burst through the thinning canopy. The giant branches slope downwards and carry you to the relative safety of the valley rim.

Your heart still racing, you slow your horse and dismount, securing the damaged saddlebag while trying to ignore the forest groaning and shifting behind you.`;}
...
You mount the horse and loosen the reins. The beast lowers its head and hurtles down the tunnels of glowing moss.
...
You slide from the saddle and flop onto the sand, gasping for breath.

When your head has cleared enough for you to stand, you secure the damaged saddlebag and tend to your horse as it stands there, still shaking beneath the star-filled sky.`;}
...
From a distance, the mingling clouds appeared violent, dark storm clouds and white summer clouds twisting together in a great whirlpool of sky. Yet as you step into the rolling vapours, you discover that the winds here are strangely calm.
...
Eventually the roots begin to descend and you emerge safely upon the valley rim.`;}
    ...
    if (wizard === "yellow") { return `You walk through the mingled clouds, and the experience is revitalising.
...
Water flows gently amongst the trees and the newly formed lake seems shallow in places. You lead your horse carefully through the rising water.
...
If they reach the great tree while you are crossing it, your path forward will vanish.`;}
...
Stone shatters around you. Trees topple into the sky and great slabs of earth drift apart. The fragments remain suspended in the air, held aloft by the magic of the realm, but they no longer sit at the same height. Some rise, others sink, while smaller fragments slowly revolve around one another.
...
Crossing them will require strength, balance and perfect timing.`;}
...
When you finally reach it, you discover your mistake. This is no wind. The tunnel is filled with the remnants of the rift itself. Invisible currents of magic tear through the stone passage with enormous force.
...
Before you have time to gather your wits, a vast shadow silently passes across the stars above.`;}  
...
Some fragments slowly rise while others sink into the clouds below. Small fragments tumble between them while loose stones occasionally fall away into the endless sky.
...
You are almost disappointed by how easily you descend the sheer cliff face. All too soon, you are safely on the fallen tree, crossing the abyss and climbing through the enormous trunk itself to emerge upon the valley rim.`;}
...
You casually leap from your platform to the next, then run across it and jump to the next. With the potion coursing through you, nothing could be easier. You spring from one drifting island to another as though crossing stepping stones in a stream.
...
The darkness becomes as clear as daylight. Tiny cracks, narrow ledges and hidden handholds stand out with perfect clarity. Suddenly, what seemed an impossible climb before now looks like child's play.

You hop over the edge and start swinging from handhold to ledge to outcrop. The route down is not only easy, it is highly enjoyable, and with your enhanced vision you are able to identify small silver growths hidden deep within the rock, which you scoop up as you climb.
...
case "Environment2CliffPotionCatChoice":
    if (wizard === "green") { return `Feeling pleased with your potion choice, you head down the valley slope.`;}
    if (wizard === "yellow") { return `You head over to the bridge that exits the platform, leaving the shattered platform behind you.`;}
    if (wizard === "blue") { return `Feeling pleased with your potion choice, you continue your journey across the silver sands.`;}   
...
You descend the cliff face in less than a minute, then traverse the fallen tree as if strolling through a park. Even with the drifting magic roaming through the air around you, the potion makes sure your foot always falls true. You don't even notice the climb through the branches to the opposite bank.

In no time at all, you emerge safely on the other side of the yawning chasm and step onto the valley lip.
...
In no time at all, you are stepping safely onto the bridge platform.

GAIN 2 LUCK.`;}
if (wizard === "blue") { return `You uncork the bottle and gulp it down. The Wayfinder enhancement reveals the route immediately.

Every ledge, crack and handhold becomes obvious. You hop over the edge and swing from handhold to handhold, knowing that you cannot fail. The route is so clear, laid out in front of you, and almost step by step, it guides you.
...
There is no safe route. The only jump available to you is the forty-foot drop to the bridge platform below.
...
case "Environment2CliffSurviveFallChoice":
    if (wizard === "green") { return `After what feels like an age, you arrive at the lip of the valley beyond and start your painful descent.`;}
...
These creatures clearly do not belong here. They are Cinder Hares: highly magical creatures that belong to the Realm of Fire, much sought after for their speed-enhancing fur.
...
At last you recognise them. Ember Runners. Not creatures of the Air Realm at all. Highly magical creatures that belong to the Realm of Fire, much sought after for their speed-enhancing feathers.
...
Its ears twitch and it lets out a throaty cry. The other hares stop instantly, and the pack turns, a dozen burning eyes fixing upon you.
...
Their razor-sharp beaks glint in the firelight as they close the ground between you in seconds.

YOU MUST FIGHT

These creatures can sometimes attack TWICE in one combat round.`;}
    if (wizard === "blue") { return `You have barely begun following the strange creatures before one lets out a deep, throaty croak. The others stop, turn quizzically and begin a deep growl when they see you.
...
You swing yourself onto your horse and urge it into a gallop. The world becomes a blur of white cloud and orange fire as you dart through the cloying smoke, burning trees only visible when you are but a few feet from them.
...
You urge the horse on. Columns of rock explode around you as the collapsing cavern groans above. You are almost to the other side when a great gout of fire erupts from the floor. There is no way to avoid it. Your horse shrieks, but you are through it in a heartbeat and racing up the tunnel beyond.
...
You cannot believe your luck. Actually, you are running through choking smoke with the world burning around you, so maybe fortune is not your companion at the moment, but the fur is a real boon. Prized by warriors throughout the realms, it is said to grant the bearer incredible speed in battle.
...
The heat is almost unbearable, yet the strange fowl continue weaving effortlessly through the burning woodland.
...
You cannot believe your luck. Actually, you are running through choking smoke with the world burning around you, so maybe fortune is not your companion at the moment, but the feather is a real boon. Prized by warriors throughout the realms, it is said to grant the bearer incredible speed in battle.
...
if (wizard === "blue") { return `Your lungs burn as you notice another colony of Magma Toads bounding through the cavern ahead, and you race after them.

Again and again, they alter course only moments before fresh pillars of rock explode from the floor.

As one of the creatures lands upon a jagged slab of stone, its hind leg catches on a razor-sharp edge.
...
Moments later, you are out of the cave and beneath the star-filled sky once more, coughing as the cool night breeze clears the smoke from your lungs.`;}   
             
case "Environment2RedItmChoice":
    if (wizard === "green") { return `You carefully stow the tuft of enchanted fur amongst your belongings before continuing your journey.`;}
    if (wizard === "yellow") { return `You carefully stow the feather amongst your belongings before making your way to the bridge leading from the island.`;}
    if (wizard === "blue") { return `You carefully stow the vial of blood amongst your belongings before continuing along the shoreline.`;}
