...
export function resolveVillageHallVariable(path, playerStats) {
    ...
    switch (path) {
        ...
        case "villageHallScene":
            if (wizard === "green") {
                return `She turns the talk to the virtues of the realms, and you are thrilled when she brings into focus the realm of nature enchantment, of roots, rivers and living forests. Your realm. She raises her hands, and the hall itself begins to transform.
