...
With a wrenching roar, the world tears apart beneath your feet as a rift between realms opens. Water tumbles into a howling maw, as the rift rips a gash in reality.

The stepping stones now hang between worlds, suspended above a vast black abyss. The far bank still remains ahead of you, while the hillside behind has become little more than a distant ledge. Below, there is only darkness without end.
...
As you turn carefully to descend, you glimpse your own world through one of the tears. Not just your world, but your home, your library. Through the rift, upon a tantalisingly close table, is one of the most powerful spellbooks in your possession.`;}    
        ...
        case "riftEnterChoice1":
            if (wizard === "green") { return `Will you try to reach through the rift and take the book?`;}
            if (wizard === "yellow") { return `Will you try to reach through the rift and take the book?`;}
            if (wizard === "blue") { return `Will you try to reach through the rift and take the book?`;}   
...
You slow down as your nerves settle, continuing the climb at a gentler rate and eventually reaching its summit, pausing to look out across the land beyond.
