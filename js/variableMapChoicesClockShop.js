...
`;
 ...
 case "clockShopEnquire":
    if (wizard === "green") {
        return `The tall woman behind the counter sets down her tools as you admire the instruments. You ask if any of them are magical.

Her smile vanishes instantly, the boy gasps, and the man, looking nervous, lays the drum he’s working on down.

His voice is hushed when he speaks. “That sort of talk brings trouble,” he says. “People start thinking music does things it shouldn’t. We tune wood and string here. Nothing more.”
`;
    }
    if (wizard === "yellow") {
...
The effect is immediate. The old man slams what he is working on down. “We don’t deal in tricks or nonsense here. Honest timepieces, nothing else.” He appears red in the face as he starts to rise. The woman stands behind him, arms folded, glowering at you, and the boy stares at you wide-eyed and scared.
...
case "clockShopFight":
    if (wizard === "green") {
        return `The bearded man is now standing fully upright, arms folded across his chest, as you try to defend magic, but the mood in the music shop just becomes more tense.

“That’s enough,” the man says, his voice deep and threatening. He reaches slowly beneath the counter. “I’ll not have that talk in my shop.” He lifts a heavy spiked bat and steps towards you.
`;
    }
    if (wizard === "yellow") {
        return `As you try to explain that magic is a peaceful and misunderstood art, the astronomer’s already stretched patience finally snaps. He lowers his instrument and stares at you directly.

“LIES,” cries the man. “LIES, LIES, LIES!” His face is red, his eyes bulging. “That’s not how the sky works.” He grabs a large brass telescope and swings it at you. “And it’s not how honest people talk. Be gone, DEVIL!”
`;
    }
    if (wizard === "blue") {
        return `The already tense mood in the clockmaker’s shop stiffens further as you try to explain that magic is a peaceful and misunderstood art. The more you talk, though, the tighter the bald clockmaker’s jaw becomes until eventually he sets down his tools with deliberate care and picks up a ball-peen hammer.

“There are no such things,” he says again, slower this time, raising the hammer. “And I don’t like you pretending there are.”
`;
    }
    if (wizard === "red") {
        return `As you try to explain that magic is a peaceful and misunderstood art, the fair-haired man’s expression darkens. He picks up a heavy melting pot, testing the weight in his hands.

“No,” he says. “We are honest people. We sell light, and I will not brook your evil mongering in my shop.” He steps forward and takes a swing at you with the heavy saucepan.
`;
    }
...
“The Parting Stones,” he spits. “South. That’s what I’ve heard. Out past the foundry. Now get out of my shop.”
`;
    }
    if (wizard === "yellow") {
...
case "clockShopPostFight":
    ...
    if (wizard === "yellow") {
        return `The astronomy shop is in disarray. Star charts hang torn from the walls; brass instruments lie smashed and strewn across the once-organised space.
...
case "clockShopSearch":
    if (wizard === "green") {
        return `Beneath a collapsed display shelf, you discover a handcrafted travelling violin, obviously valuable, inside a hard leather case. There is a false base inside the same case, in which you find a small sealed pouch of rare resin and pitch. You pocket both.`;
    }
    if (wizard === "yellow") {
