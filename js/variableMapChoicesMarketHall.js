...
export function resolveMarketHallVariable(path, playerStats) {
    ...
    switch (path) {
        ...
        case "marketHallGetInvolved":
            ...
            if (wizard === "yellow") {
                return `If you wish to help the devil woman hauling the unconscious man.`;
            }
            if (wizard === "blue") {
        ...
        case "marketHallTakeDare":
            if (wizard === "green") {
                return `If you wish to place your head in the Screaming Death.`;
            }
            if (wizard === "yellow") {
            ...
            if (wizard === "red") {
                return `If you wish to plunge your face into the burning coals.`;
            }  
        ...
        case "marketHallAvoidDare":
            ...
            if (wizard === "yellow") {
                return `If you would rather not drink blood and leave the churchyard.`;
            }
            if (wizard === "blue") {
        ...
        case "marketHallDontDoIt":
            if (wizard === "green") {
                return `Would you rather give the whole statue-head thing a miss?`;
            }
            if (wizard === "yellow") {
                return `Would you rather give the whole drinking-the-Sister's-Bubbling-Blood thing a miss?`;
            }
            if (wizard === "blue") {
                return `Would you rather put the helm back on the armour?`;
            }
            if (wizard === "red") {
                return `Would you rather give the whole plunging-your-face-into-burning-coals thing a miss?`;
            }            
        ...
        case "marketHallSurvived":
            ...
            if (wizard === "yellow") {
                return `You laugh weakly, unsure whether she was teasing or not, and head back out to the street.`;
            }
            if (wizard === "blue") {
        ...
        case "marketHallHelp":
            ...
            if (wizard === "yellow") {
                return `Help the devil woman still struggling with the unconscious man.`;
            }
            if (wizard === "blue") {
        ...
        case "marketHallRoadside":
            ...
            if (wizard === "blue") {
                return `Heading south down Market Street, leaving the inn behind you, you soon come to a large timber building flying the star flag and colours of the town militia. Painted above the entrance are the words: 'Soldier Training Hall'. From inside come the clatter of weapons, shouted orders and bursts of rough laughter.`;
            }
            if (wizard === "red") {
                return `You soon notice a heat haze drifting above the rooftops, and before long you find its source: a soot-blackened foundry built around a towering stone furnace. Thick iron pipes run along the outer walls, while smoke and glowing embers billow endlessly from the high chimneys overhead. The air here is stifling, carrying the smells of burning coal and molten metal.`;
            }      
            
        case "marketHallEntrance":
            if (wizard === "green") {
                return `The market hall is crowded as merchants, labourers and travellers barter beneath the smoke-darkened rafters. Stalls packed with bread, salted meats and trinkets line the walls, while hawkers shout over one another to draw customers in. Near the centre of the hall, a gaunt man is struggling to lift a grotesque carved head onto a wooden stand. The thing is enormous—its mouth stretched open in a frozen scream.

'Someone give us a hand with this thing, will you?' the man calls. 'It weighs a ton.'`;
            }
            if (wizard === "yellow") {
                return `The church courtyard is quiet. You can just about make out what you presume to be a few scattered worshippers lingering in the shade beneath the old stone arches. A small unmanned wooden stand displays bread, figs and cups of dark mead, while black incense smoke cloys the warm air. Near the centre of the courtyard, beside a marble fountain filled with thick dark-red liquid, a horned, red-skinned woman with small black wings is struggling to drag an unconscious man away from the fountain's edge.
...
The man exhales shakily and wipes the sweat from his brow.
...
The horned woman exhales softly and brushes the dust from her dark robes.

'Thank you,' she says with a faint smile. 'You've a kinder heart than most.'

She gestures towards the marble fountain nearby.
...
'The Armour of Screaming Death,' cries the bigger of the soldiers, stepping back.

Not so wary of magic, you pick up the helm and, as you do, you feel an overwhelming compulsion to put it on your head.`;
            }
            if (wizard === "red") {
                return `You rush forward and help the woman. The iron burns hot enough to sting even through the heavy gloves she threw to you. Crimson sparks burst around your feet as the two of you fight to right the brazier. Finally, with one last heave, the enormous bowl crashes back onto its stand.

The woman exhales heavily, flexing her soot-covered fingers.
...
'The Widow's Furnace,' she says quietly. 'Used for forging blood magic into weapons. Said to bring great peace to any who plunge their face into it. Not felt the need to try it myself.'
...
You stare into the foul-smelling smoke at the crimson coals within and find that you now have an overwhelming urge to plunge your face into it.`;
        ...
        case "marketHallShop":
            ...
            if (wizard === "yellow") {
                return `Other than the bubbling red fountain and the winged woman dragging the unconscious man, the only other thing of interest is the table covered with food. On examination, you find an honesty box and a sign saying: "Help yourself. All items 2 gp."`;
            }
            if (wizard === "blue") {
                return `Other than the soldiers struggling with the armour, all the other stalls are offering food and rations for the recruits. You can stock up on provisions at a cost of 2 gp per pack.`;
            }
            if (wizard === "red") {
...
You glance towards the unconscious man and notice that his lips are stained crimson, then over to the winged woman, who is watching you carefully from beneath the cloister's shade.`;
            }
            if (wizard === "blue") {
...
A cold, sharp pressure tightens around your neck. Darkness swallows you whole as the silence is torn apart by a distant, ringing scream. You try to pull free, but your head is trapped... then a deep and overwhelming peace washes over you.
...
It is unpleasantly warm and tastes unmistakably of blood. You recoil in disgust and almost choke it up again—but then your body relaxes, a warmth washes over you, and all your aches and pains seem to melt away.
...
You remove the helm and breathe deeply, feeling remarkably revitalised. You replace the helm on the armour.

The soldiers look at you in awe.`;
            }
            if (wizard === "red") {
                return `You plunge your face into the coals. Agony tears through you as the flames rip at your flesh. You would scream, but your face is on fire and smoke floods your lungs like molten metal. You are burning alive... then darkness. Silence.

But you are not dead.

You lift your face from the coals and touch your skin. You are unharmed. In fact, you feel stronger, revitalised, better than you did before plunging your face into the burning coals.

GAIN 4 STAMINA points.

'Well, who'd have thought,' says the lady.`;
            }
