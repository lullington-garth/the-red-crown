...
She waves over her husband, who, like her, seems stunned to see the lantern. When, having no use for it yourself, you offer it to them, you think they might faint.
...
Bram holds up the lantern and calls out, "The Long Shadow is home! A round on the house."

There is a hearty cheer from the patrons.
...
You look up at the tower, asking why they cannot simply shine the light as a beacon.
...
This gives you an idea. You pull the Lantern of the Long Shadow from your pack, asking if it might be of use.

The private looks from the lantern to you and back again, clearly uncertain what he is seeing. Before he can answer, however, a voice calls from the doorway of the Shadow House.

"You there! Bring that here. Quickly!"

An officer stands beneath the entrance arch, his eyes fixed upon the lantern.
...
He looks around at the men. "Keep that lantern burning," he says, then turns back to you. "Come and join us in the officers' mess. The least we can do is feed you."
...
He lets out a startled yelp, but there is no way for him to stop in time, and he bundles right into you.
...
An elderly man seated beneath a nearby oak rises from his chair. His robes are woven from leaves and bark cloth. He places the staff that was across his lap with the collection of other carved staffs leaning against a broad tree.
...
He assures you that no harm will come to your staff and that, when he returns it, it will increase your magic reserves. When you agree to his offer, he says, "Good, leave it with me. Why don't you wait in the Long Shadow while I work? If you say I sent you, I expect Elowen will rustle up some food for you."

You head over to The Long Shadow, where indeed Elowen prepares a meal for you. You are just finishing the simple but hearty fare when the old mage returns carrying your improved staff. He looks thoroughly delighted.
...
"He's got a Sky Shard."

The woman's eyes widen as she notices the shard.

"Krint! Krint! Come and see this!"

A broad-shouldered man emerges moments later.
...
"You don't charge to work on a Sky Shard in my trade. You do it because it is the right thing to do. Those shards hunger for power, and any staffsmith fortunate enough to encounter one works for the love of the craft."

He refuses all discussion of payment and is delighted when you agree.

While he works, you share a meal with his wife, Mary, and young Bless. The food is simple but hearty, and by the time you have finished eating, Krint returns carrying your upgraded shard.

He looks positively delighted.

"It took to the tuning beautifully," he says. "Though, of course, it did."

Once again, he refuses any payment and instead thanks you for allowing him to work on the shard.`;}
            if (wizard === "blue") { return `You assure the armourer that no harm has been done. Between the two of you, you collect the fallen weapons. He had been ambitious trying to move them all in one load, and you offer to help him carry them to wherever they are going.

"Thanks," says the man. "Need to get them to the armoury. My name is Serin, by the way. Please, it's this way."
...
You are carefully laying your load onto a nearby bench when Serin says, "Is that... is that a Crystal Shard?"

He dumps his weapons, and Serin examines your shard with obvious fascination.

"I've been studying enchanted weapons for years, military and otherwise, but I've never seen anything as potentially powerful as a Crystal Shard. Can I tune it for you?" He looks at you hopefully. "I'd receive a lashing if anyone caught me working on civilian equipment, but a Crystal Shard..." He shakes his head. "It's a once-in-a-lifetime opportunity."

You say you don't want to get him into any trouble, but he just smiles.

"This," he says, taking the shard and placing it on the bench, "is worth a beasting."
...
After some time, Serin passes the shard back to you. The crystal glows more brightly than before, and you can feel its increased focus immediately.

"It accepted the tuning beautifully," he says. "I only wish I had another hundred years to study it."

When you ask what you owe, he just laughs.

"It's on the Silver Shore Military, that one."`;}     

        case "settlementSkyShardYesChoice":
            if (wizard === "green") { return `You thank Caelan for his work and Elowen for the meal, then continue on your journey.`;}
            ...
            if (wizard === "blue") { return `You thank Serin for both the meal and his work, then head into town towards the plateau.`;} 

        case "settlementHint":
            if (wizard === "green") { return `Elowen and Bram insist on giving you a meal. When you pull out your coin pouch, Bram waves it away.

"You don't pay here," he says.
...
"If I were you, I'd stay well clear of that lot."`;}
...
"Seems to attract all sorts too," says Krint, wiping the last of his stew from his bowl. "Old Teddy Cliftweedle has given one of his fields over for a funeral pyre. None of them are from around here either. Strange folk. Who wants to lay their dead to rest on land they never knew?"
...
"I've heard sailors speak of it. It's a silver-blue path and the warden that guards it," says Marek. "Not on any map I've ever seen, though. Not something the military seem to have much interest in. We have bigger things to worry about at the moment."

He studies his bowl.

"The weakening boundaries have caused no end of trouble."

Another officer snorts.

"All sorts coming through now."

Marek nods. "We have an open rift down in Finger Cave. Nobody knows where it leads."

"Something has infested the coral beds as well," says a lieutenant. "Blue spirits or sea ghosts. Nobody really knows."

A third officer shakes his head.

"And people have started leaving offerings for the Kraken again. Madness. Why invite a monster to your shores?"

Marek sighs.

"We spend more time chasing rumours than defending the coast these days."`;}     
...
The second bridge is broader and sturdier. Beyond it lies what would usually be a beautiful meadow lined with trees, but today the platform is crowded with figures in sombre clothing gathered around a massive unlit bonfire.
...
One route descends towards a silver-sanded inlet where dozens of strange creatures paddle through the shallow waters. Their dark backs rise and fall beneath the reflected stars. From this distance, they resemble some kind of herd grazing upon the sea itself.
