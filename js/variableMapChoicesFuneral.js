...
const wizardYou = (playerStats.wizardColor || "").toLowerCase();
    ...
    switch (path) {
        ...
        case "FuneralEntrance":
            if (wizard === "green") { 
                return `The woodland path emerges into a broad rolling meadow. Around its edges stand brightly painted wagons, canvas shelters, and makeshift pens for animals. Smoke drifts lazily upwards from numerous campfires, while voices and hymns carry upon the breeze.
...
Standing before them is a broad-shouldered priest clad in white and gold. In one hand, he carries a long sceptre crowned with a crystal that catches the firelight. His voice booms across the meadow as he preaches the word of the One True God.
...
Will you...`;
            ...
            if (wizard === "blue") { 
                return `The shoreline gives way to a vast coral bed exposed by the retreating tide. Pools of dark water lie between forests of crimson and blue coral, while countless tiny shells glitter beneath the star-filled sky.

Across the coral bed, sea nymphs with flowing hair of blue and silver dance among star nymphs whose pale skin glimmers like moonlight. Their movements spread across the exposed reef in widening circles, passing from dancer to dancer until the dance seems to flow from the sea itself into the heavens above. Silver lights spiral upwards, while reflections dance upon the water below.
...
Will you...`;
        ...
        case "FuneralMeet":
            if (wizard === "green") { 
                return `As soon as the priest sees you, he raises his sceptre high above his head and, in a deep, carrying voice, cries, "Praise the Lord! A lost lamb has wandered into our flock!"
...
Will you...`;
            ...
            if (wizard === "yellow") { 
                return `As you approach the mourners, you become painfully aware of your bright clothing and the fact that you do not belong here. A ripple of angry muttering spreads through the otherwise respectful gathering.

Will you…`;
            }
            if (wizard === "blue") { 
                return `The nymphs pay you little attention as you walk among them. Their dance simply flows around you, never breaking, never faltering. Wherever you step, the dancers bend and turn as though water moving around a stone.
...
Will you...`;
        ...
        case "FuneralOffer":
            if (wizard === "green") { 
                return `The priest descends from his platform and grips your shoulders.
...
What will you offer to the One True God...`;
            ...
            if (wizard === "yellow") { 
                return `"Tongo would have liked the idea of a stranger bringing a gift," says a tearful woman around whom much of the congregation has gathered.
...
Will you give up…`;
            ...
            if (wizard === "blue") { 
                return `The treasure circle stretches farther than you first imagined.
...
Will you sacrifice an item to the treasure ring...`;
        ...
        case "FuneralOfferMagic":
            if (wizard === "green") { 
                return `The priest begins to weep as you reveal your offering. His hands tremble, and he falls to his knees beside the altar, raising both arms towards the heavens.
...
Eventually, his fervour begins to subside.`;
            ...
            if (wizard === "yellow") { 
                return `A woman begins to weep as you produce your offering.
...
The fire quickly catches.`;
            ...
            if (wizard === "blue") { 
                return `As your offering settles among the treasures, the dance turns towards you. Soft hands take yours, and the dance embraces you.
...
Eventually, the music begins to fade.`;
        ...
        case "FuneralOfferItem":
            if (wizard === "green") { 
                return `As you place your offering at the foot of the altar, you immediately realise that you have chosen poorly.
...
You stagger backwards as he raises the sceptre once more, and the congregation begins shouting and peppering you with stones.`;
            ...
            if (wizard === "yellow") { 
                return `As you place your offering at the foot of the pyre, you immediately realise that you have chosen poorly. The tension among the mourners becomes almost unbearable.
...
You have outstayed a welcome that was never truly offered.`;
            ...
            if (wizard === "blue") { 
                return `As you place your offering within the treasure ring, you immediately realise that you have chosen poorly.
...
The queens' faces become grey and terrible. Together, they raise their heads and release a pair of ethereal cries that echo across both sea and sky.`;
        ...
        case "FuneralPayRespects":
            if (wizard === "green") { 
                return `"Join us in prayer?" the priest repeats. His smile slowly disappears. "JOIN US IN PRAYER WITHOUT FIRST MAKING AN OFFERING?"
...
You stumble backwards as he advances upon you, raising the sceptre again, the congregation watching on in silence.`;
            ...
            if (wizard === "yellow") { 
                return `"Pay your respects? PAY YOUR RESPECTS?"
...
Every eye in the gathering is now fixed upon you. Mumbling apologies, you slowly back away.`;
            ...
            if (wizard === "blue") { 
                return `Caught up in the moment, you attempt to join the dance, but you cannot come close to matching the easy grace of the nymphs.
...
The vision lasts only an instant. The branches become antlers. They take the form of a great horned sentinel clothed in silver-green ribbons that drift like seaweed upon a tide.
