...
Will you:`;}   
        ...
        case "soldierPrisonerChoice2":
            ...
            if (wizard === "blue") { return `Release her from the mast?`;}   
        ...
        case "soldierPrisonerBargain":
            if (wizard === "green") { return `The man slumps in the net, the anger slowly draining from his face. He ceases struggling and lets out a long sigh.
...
"But do not leave just yet. I have with me a Potion of Ogre Strength. I know what you are thinking: if I possess such a potion, why am I still trapped inside this wooden cage? I am terribly allergic, friend. I try and drink it, my skin falls off," he says with a chuckle, "but perhaps you may find it useful on your travels. For you, such a thing may be a great boon."
...
Taking the potion, you drop 4 Gold Pieces into his pack.`;}
            if (wizard === "yellow") { return `"The prisoner laughs. I suppose I am in no position to haggle. 4 Gold Pieces it is."
...
You decide it is best not to linger.`;}
            if (wizard === "blue") { return `You feel terrible for what has happened. Your intention had been to save the young woman, not to kill her. But there is nothing that can be done now.
...
Far below stretches a dense forest whose canopy forms an unbroken sea of green. Ancient trees crowd together beneath the canopy, their branches concealing much of the woodland floor. Towards the centre of the forest, you can see a faint silvery glow shining among the trees.`;}
