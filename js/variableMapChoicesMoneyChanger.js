...
Although the shop appears empty, you can hear the faint sound of coins being counted somewhere beyond a curtained archway to one side.`;
            }
            if (wizard === "yellow") {
                return `You step inside the gloomy shop, and the door creaks shut behind you with a slow moan. Dust and burnt candle fumes choke the stale air of the darkened room. As your eyes slowly adjust, you begin to make out wooden grilled counters lining the walls, their iron bars, thick with spiderwebs, casting long shadows across the floor. Behind the bars sit tiny scales, ledgers and trays filled with unfamiliar coins from distant lands, all locked securely away.
...
The shop feels unnaturally quiet, every sound swallowed by the thick gloom. Then, from somewhere beyond a curtained archway to your right, you hear the faint but steady sound of coins being counted with nervous haste.`;
            ...
            if (wizard === "blue") {
                return `Inside is a riot of colours and competing smells. Bright rugs cover the floor, and every surface seems piled high with curious objects. Jars of dried herbs, bundles of feathers, painted masks, candles, crystals and loose coins are scattered everywhere.

Piles of silver and gold coins sit openly upon the counters. Between the jars and throw cushions, you are hard-pressed to see a surface where one coin or another has not been discarded.
...
‘I... I thought I locked the shop,’ he says, his eyes darting around the room and then behind you, presumably to see if you are alone.
...
‘What do you want?’ he asks, trying to sound calm, though his whole body is held in an attitude of tense alarm. If you were not blocking the only exit, you expect he would have already bolted.`;
            }
            if (wizard === "blue") {
                return `Pushing aside the hanging beads, you step into a warm back room thick with sweet-smelling smoke. Sitting cross-legged upon a pile of cushions is a podgy young man with tangled hair, colourful robes and half-closed eyes. Nestled amongst the cushions he appears to be sitting on, is a curious rune-covered chest, although he seems completely oblivious to it.
...
‘There's no stones here. None. So you'd best be off,’ he says, scooping the coins off the desk and into a bag. ‘Try looking outside, or down the road, or somewhere else... and lock the door behind you when you leave. Thank you.’`;
            }
            if (wizard === "blue") {
...
'I am Barney,' he says, seeming pleased about that.
...
You ask if he knows where the standing stones might be now. He squints thoughtfully at you.

‘Head towards the stones, man... unless they are still singing... then you’re probably close to the moon.’
